...
def get_boot_info_base(self, boot_filename):
    ...
    memberDict = {"name": None, "label": None, "host": None, "port": "not set", "fhicl": None, "subsystem": "not set", "allowed_processors": "not set", "prepend": "not set"}
           ...
           i_line == len(lines) - 1:
            ...
            if filled_process_info:
                ...
                for varname in memberDict.keys():
                    if varname != "port" and varname != "subsystem" and varname != "allowed_processors" and varname != "prepend":
