...
trace_control_tshow_outfile='$HOME/.biery/traces/r$run.\`hostname -s\`.trc'
trace_control_logfile='$HOME/.biery/traces/r$run.$transition'
trace_control_nodelist='np04-srv-0{01-4,11-18}'
trace_control_upsdb=/nfs/sw/artdaq/products
trace_control_trace_version=v3_13_09
trace_control_run_records_dir=/nfs/sw/artdaq/run_records
RGANG=`which rgang`
